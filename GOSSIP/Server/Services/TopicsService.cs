...
public static class TopicsService
{
    public static List<uint> SelectAllIds(MySqlConnection conn)
    {
        ...
        // {
        //     List<ParentReplyModelID> replies = [];
        ...
        //     {
        //         ReplyModelID reply = repliesReader.IsDBNull("reply_parent_reply_id")
        //             ? new ParentReplyModelID()
        //             : new ChildReplyModelID();
        //
        //         reply.ID = repliesReader.GetUInt32("reply_id");
        //         reply.User = new UserModelID
        //         {
        ...
        //         {
        //             childReply.ReplyTo = new UserModelID
        //             {
    ...
    {
        var TopicModelIDs = SelectAllIds(conn);

        List <TopicModelID> topics = [];

        foreach (var topic in TopicModelIDs)
        {
            topics.Add(SelectById(topic, conn));
        }
    ...
    // public static List<TopicModelID> SelectPage(int pageNumber, int pageSize, MySqlConnection conn)
    // {
    //     List<TopicModelID> topics = [];
    //
